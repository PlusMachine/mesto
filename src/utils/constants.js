...
export const buttonOpenPopupEditAvatar = document.querySelector(".profile__button");
...
export const formEditAvatar = popupEditAvatar.querySelector(".popup__form-edit-avatar");
...
export const inputAvatarElement = formEditAvatar.querySelector(".popup__form-field_input_avatar")
